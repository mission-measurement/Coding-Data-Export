...
namespace MM.Data.Export
{
    class Program
    {
        ...
        {
            Console.WriteLine("Please enter the Genome ID:");
            var genomeID = int.Parse(Console.ReadLine());
            GenomeExport genomeExport = new GenomeExport();
            genomeExport.BuildExport(genomeID);
            

            //**Workforce Export
            //var docs = GetDocuments(10);
            //foreach (var d in docs)
            //{
            //    ProcessDocumentGenes(d);
            //}
